...
public class Dialog extends DialogFragment {
    ...
    public Dialog(String title, String actionTitle, String msg, boolean isCancelable, boolean isHideCancelButton, View.OnClickListener onClickListener) {
        this.title = title;
    ...
    public Dialog(@NonNull String title, String msg, boolean isCancelable, boolean isHideCancelButton, View.OnClickListener onClickListener) {
        this.msg = msg;
        this.title = title;
        this.onClickListener = onClickListener;
        this.isCancelable = isCancelable;
    ...
    public Dialog(@NonNull String title, String msg, String actionTitle, View.OnClickListener onClickListener) {
        this.msg = msg;
        this.title = title;
        this.onClickListener = onClickListener;
        this.actionTitle = actionTitle;
